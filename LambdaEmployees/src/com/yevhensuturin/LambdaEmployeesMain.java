...
public class LambdaEmployeesMain {
    public static void main(String[] args) {
        ...
        Function<Employee, String> getLastName = (employee) -> {return employee.getName().substring(employee.getName().indexOf(" ")+1);};
        ...
        System.out.println(getName(getFirstName, employees.get(1)));
        System.out.println(getName(getLastName, employees.get(1)));
...
//        printEmployeesByAge(employees, "\nEnployees ynger than 25", new Predicate<Employee>() {
//            @Override
