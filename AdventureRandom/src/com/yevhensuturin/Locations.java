...
public class Locations implements Map<Integer, Location> {
    ...
    //3. The next section of the file will contain the index (the index is 169 bytes long. It will start at byte 8 and end at byte 1699
    ...
    static {
        try{
            ...
            while (ra.getFilePointer() < locationStartPoint){
                ...
                index.put(locationID, new IndexRecord(locationStart, locationLength));
            }
        } catch (IOException e){
    ...
    public Location getLocation(int locationID) throws IOException{
        ...
        String exitsString = ra.readUTF();
        String[] exitsPart = exitsString.split(",");
